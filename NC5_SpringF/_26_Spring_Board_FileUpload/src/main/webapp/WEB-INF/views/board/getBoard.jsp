...
<body>
	...
	<div
			...
			<table border="1" style="border-collapse: collapse;">
				<tr>
					...
					<td style="text-align: left"><input type="text"
						name="boardTitle" id="boardTitle" value="${board.boardTitle }">
					</td>
				</tr>
				<tr>
					<td style="background: skyblue;">작성자</td>
					<td style="text-align: left"><input type="text"
						name="boardWriter" id="boardWriter" value=${board.boardWriter }
						readonly></td>
				</tr>
				<tr>
					<td style="background: skyblue;">내용</td>
					<td style="text-align: left"><textarea name="boardContent"
							id="boardContent" cols="40" rows="10">${board.boardContent }</textarea>
					</td>
				</tr>
				<tr>
					<td style="background: skyblue;">작성일</td>
					<td style="text-align: left">${board.boardRegdate }</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="background: skyblue;">첨부파일</td>
					<td><c:forEach items="${boardFileList }" var="boardFile">
							<div>
								<img src="/upload/${boardFile.boardFileName }"
								width="100px" height="100px">
								<p style="cursor:pointer" onclick="fnFileDown{${boardFile.boardNo},${boardFile.boardFileNo }}">
		...
		<hr />
		<a href="/board/insertBoard.do">글 등록</a> <a
			href="/board/deleteBoard.do?boardNo=${board.boardNo }" id="btnDelete">글
			삭제</a> <a href="/board/getBoardList.do">글 목록</a>
	</div>
