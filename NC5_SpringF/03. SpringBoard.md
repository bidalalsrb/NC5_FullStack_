...
1. 쿼리스트링(querystring)
    - url 주소 뒤에 ?key1=value&key2=value2&.....&
    keyn=valuen 형식으로 여러개의 파라미터를 붙여서 보낼 수 있는 방식
    - 백엔드에서는 @RequestParm("key")을 이용하여 하나씩 변수와 매핑해주거나 Map을 이용하여 한 번에 받아서 사용할 수 있다. 키값과 일치하는 변수를 갖는 커맨드 객체로도 받아서 사용할 수 있다.
2. url 파라미터
    - url 주소 뒤에 /value1/value2/.../valuen 형식으로 파라미터를 붙여서 보내는 방식
    - 백엔드에서는 url 매핑 주소에 /{변수명1}/{변수명2}/.../{변수명n}으로 매핑하여 사용한다.
